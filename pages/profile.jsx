      ...
      <div className='max-w-screen mx-auto px-4 pt-12 lg:flex lg:items-center lg:pt-32'>
        <div className='mx-auto max-w-3xl text-center'>
          ...
          <div className='mt-6 flex flex-wrap justify-center gap-4'>
            <Link href='/'>
              <a className='block w-full rounded border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-opacity-75 sm:w-auto'>
                Home
              </a>
            </Link>
            <Link href='/about'>
