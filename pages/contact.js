  ...
  return (
    <section className='mx-auto bg-slate-100 dark:bg-gray-900'>
      <div className='w-full px-6 pt-8'>
        <div className='container relative mx-auto  flex flex-col items-center rounded-lg bg-primary dark:bg-primary pt-12 pb-24 sm:pt-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64'>
